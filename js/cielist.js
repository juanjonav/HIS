const codigoscie = {
    ...
    "APP150": "Actividad con autoridades y líderes comunales",
    "APP108": "Actividad en comunidad",
    "APP144": "Actividad con docentes",
    "APP145": "Actividad con estudiantes",
    "APP136": "Actividad con familia",
    "APP93" : "Actividad con institución educativa",
    "APP166": "Actividades con líderes escolares",
    "APP151": "Actividad con mujeres",
    "APP146": "Actividad con padres de familia (en instituciones educativas)",
    ...
    "97535": "Entrenamiento para autocuidado y manejo en el hogar (Ejemplo: actividades cotidianas, actividades de la vida diaria y entrenamiento compensatorio, preparación de comidas, procedimientos de seguridad, e instrucciones para usar dispositivos /equipos de adaptación empleados para la asistencia), contacto directo uno a uno.",
    "97537": "Entrenamiento para la reintegración a la comunidad y al trabajo (ejemplo: compras transporte manejo de dinero actividades y/o trabajo no vocacionales análisis del entorno y su modificación análisis de las tareas del trabajo uso de dispositivos)",
    ...
    "90806": "Psicoterapia individual, de soporte, psicodinámica o psicoeducativa o de afronte cognitivo conductual, realizado por psicólogo",
    ...
    "F323": "EPISODIO DEPRESIVO GRAVE CON SINTOMAS PSICÓTICO",
    ...
    "F986": "FARFULLEO",
    "F988": "OTROS TRASTORNOS EMOCIONALES Y DEL COMPORTAMIENTO QUE APARECEN HABITUALMENTE EN LA NINEZ",
...
document.getElementById("BTNbuscarDiagnosticos").addEventListener("click", () => {
    // Obtener los valores de los campos CIE
    const cie1 = document.getElementById("cie1").value.trim().toUpperCase();
    const cie2 = document.getElementById("cie2").value.trim().toUpperCase();
    const cie3 = document.getElementById("cie3").value.trim().toUpperCase();

    // Completar los diagnósticos según el diccionario
    document.getElementById("diagnostico1").value = codigoscie[cie1] || "";
    document.getElementById("diagnostico2").value = codigoscie[cie2] || "";
    document.getElementById("diagnostico3").value = codigoscie[cie3] || "";
});